...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnAktivasi = (Button) findViewById(R.id.aktivasiAkun);
        btnAktivasi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainActivity.this, Aktivasi.class);
                startActivity(intent);
            }
        });

        Button btnLupaPass = (Button) findViewById(R.id.lupaPass);
    ...
    private void RequestLogin(){
        ...
        mApiService.loginRequest(npm, password)
